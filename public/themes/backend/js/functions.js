        ...
        var html = '' +
            '<div class="pl-item highlight-box">' +
                '<div class="form-group">' +
                    '<div class="col-sm-12">' +
                        '<input name="item_title[]" class="form-control" type="text" placeholder="Item title">' +
                    '</div>' +
                '</div>' +
                '<div class="form-group">' +
                    '<div class="col-sm-7">' +
                        '<input name="item_url[]" class="form-control custom-upload-value" type="text" placeholder="Photo/Video URL">' +
                    '</div>' +
                    '<div class="col-sm-5"><b>or upload </b>' +
                ...
                '<div class="form-group">' +
                    '<div class="col-sm-12">' +
                        '<textarea name="item_caption[]" class="form-control" placeholder="Type your caption..."></textarea>' +
                    '</div>' +
                '</div>' +
            '</div>';
    ...
    $.each(json, function (k, v) {
        ...
        html += '' +
            '<div class="pl-item highlight-box">' +
                '<div class="form-group">' +
                    '<div class="col-sm-12">' +
                        '<input name="item_title[]" class="form-control" type="text" placeholder="Item title" value="' + v.title + '">' +
                    '</div>' +
                '</div>' +
                '<div class="form-group">' +
                    '<div class="col-sm-7">' +
                        '<input name="item_url[]" class="form-control custom-upload-value" type="text" placeholder="Photo/Video URL" value="' + v.url + '">' +
                    '</div>' +
                    '<div class="col-sm-5"><b>or upload </b>' +
                        '<span class="btn btn-default btn-file">' +
                            'Browse <input type="file" onchange="custom_upload_file(this)" class="custom-upload-file" parent="pl-item" location="gallery" output="custom-upload-value">' +
                ...
                '<div class="form-group">' +
                    '<div class="col-sm-12">' +
                        '<textarea name="item_caption[]" class="form-control" placeholder="Type your caption...">' + v.caption + '</textarea>' +
                    '</div>' +
                '</div>' +
            '</div>';
    });
